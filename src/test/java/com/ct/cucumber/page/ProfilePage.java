package com.ct.cucumber.page;

import com.ct.framework.helpers.JavaScriptHelper;
import com.ct.framework.pages.AbstractPage;
...
public class ProfilePage extends AbstractPage {
    ...
    @FindBy(xpath = "//mat-row/mat-cell[last()]/button")
    ...
    public void removeProductFromBasket(String name){
        ...
        waitLocatorUntilInvisible(String.format(itemInBasket, name));
    }
}
